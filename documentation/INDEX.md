...
| **okno próbkowania ADC / zbocze TIMER0_CH3 / droga do FW-127** | [FW-127_STATUS.md](FW-127_STATUS.md) (zacznij TU — stan bieżący) → [FW-128C0_PHYSICAL_CURRENT_SCALE_PL.md](FW-128C0_PHYSICAL_CURRENT_SCALE_PL.md) (bieżąca karta) → [FW-128B_CONTRACT_BATTERY_LIMITER_PL.md](FW-128B_CONTRACT_BATTERY_LIMITER_PL.md) (kontrakt, NIE wdrożone) → [FW-128A_CANONICAL_CURRENT_CONTROL_OWNERSHIP_PL.md](FW-128A_CANONICAL_CURRENT_CONTROL_OWNERSHIP_PL.md) → [FW-128_PRE_AUDIT_CURRENT_CONTROL_PL.md](FW-128_PRE_AUDIT_CURRENT_CONTROL_PL.md) → [FW-127_ACQUISITION_REWRITE_PL.md](FW-127_ACQUISITION_REWRITE_PL.md) → [FW-127_PRE_AUDIT_SAMPLE_CONTEXT_COHERENCY_PL.md](FW-127_PRE_AUDIT_SAMPLE_CONTEXT_COHERENCY_PL.md) → [FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md](FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md) → [FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md](FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md) → [FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md](FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md) → [FW-126_TO_FW-127_AGENT_HANDOFF_PL.md](FW-126_TO_FW-127_AGENT_HANDOFF_PL.md) + [FW-126_HW_TEST_PROCEDURE_PL.md](FW-126_HW_TEST_PROCEDURE_PL.md) |
