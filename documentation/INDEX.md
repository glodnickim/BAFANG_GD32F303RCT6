...
| **quiet start / quiet stop / FW-117 / MOE / neutral CCR / final Iq slew** | [QZERO Quiet Zero](QZERO_QUIET_ZERO_PL.md) (bieżąca karta — wygaszanie całek PI po Iq_ref=0, przeciąganie silnika po release); [QS-3D 16 kHz final Iq slew owner](QS-3D_16KHZ_FINAL_IQ_SLEW_MIGRATION_PL.md) (przeniesienie slewu do 16 kHz, jedyny finalny owner, mailbox); [QS-3C battery limiter upstream Iq-cap](QS-3C_BATTERY_CURRENT_LIMITER_UPSTREAM_OWNERSHIP_PL.md) (właściciel limitera bateryjnego, odblokowuje 16 kHz); [QS-3B 4 kHz vs 16 kHz](QS-3B_4KHZ_VS_16KHZ_FINAL_IQ_SLEW_PL.md) (decyzja architektoniczna); [QS-3 G532 final-Iq parity](QS-3_G532_FINAL_IQ_SLEW_PARITY_PL.md) (deterministyczny 4-kHz baseline); [QS-1 diagnostics](QS-1_QUIET_START_STOP_TRANSITION_DIAGNOSTICS_PL.md) — DIAG-only capture i HMI version; [QS-1R reusable capture](QS-1R_REUSABLE_CAPTURE_USER_WORKFLOW_PL.md); [QS-1H analiza HW](QS-1H_HW_CAPTURE_ANALYSIS_PL.md); [QS-1H-R1 workflow operatora](QS-1H-R1_CAPTURE_OPERATOR_WORKFLOW_PL.md); [QS-0/QS-0B audit](QS-0_QUIET_START_STOP_CURRENT_ARCHITECTURE_AUDIT_PL.md); [G532 source](G532_CICHY_START_STOP_EVISTDRIVE_AGENT_PL.md). |
| **kanoniczna numeracja buildów** | [Globalny alokator wersji](BUILD_VERSION_GLOBAL_ALLOCATOR_AUDIT_FIX_PL.md) — wspólny HWM, lock atomowy, kontrolowane uzgodnienie historii, oficjalna para NORMAL+DIAG (`build-canonical-pair.ps1`) i tryby AUTO/REPRO/Developer. |
...
| **okno próbkowania ADC / zbocze TIMER0_CH3 / droga do FW-127** | [FW-127_STATUS.md](FW-127_STATUS.md) (zacznij TU — stan bieżący) → [FW-128B1_BATTERY_CURRENT_TIMEBASE_PL.md](FW-128B1_BATTERY_CURRENT_TIMEBASE_PL.md) (bieżąca karta) → [FW-128B0_BATTERY_CURRENT_SCALE_PL.md](FW-128B0_BATTERY_CURRENT_SCALE_PL.md) (bieżąca karta) → [PRE-FW128_PAS_CADENCE_TIMEBASE_PL.md](PRE-FW128_PAS_CADENCE_TIMEBASE_PL.md) (bieżąca karta) → [FW-128C0_PHYSICAL_CURRENT_SCALE_PL.md](FW-128C0_PHYSICAL_CURRENT_SCALE_PL.md) (bieżąca karta) → [FW-128B_CONTRACT_BATTERY_LIMITER_PL.md](FW-128B_CONTRACT_BATTERY_LIMITER_PL.md) (kontrakt, NIE wdrożone — patrz [QS-3C](QS-3C_BATTERY_CURRENT_LIMITER_UPSTREAM_OWNERSHIP_PL.md) dla wdrożonego limitera upstream) → [FW-128A_CANONICAL_CURRENT_CONTROL_OWNERSHIP_PL.md](FW-128A_CANONICAL_CURRENT_CONTROL_OWNERSHIP_PL.md) → [FW-128_PRE_AUDIT_CURRENT_CONTROL_PL.md](FW-128_PRE_AUDIT_CURRENT_CONTROL_PL.md) → [FW-127_ACQUISITION_REWRITE_PL.md](FW-127_ACQUISITION_REWRITE_PL.md) → [FW-127_PRE_AUDIT_SAMPLE_CONTEXT_COHERENCY_PL.md](FW-127_PRE_AUDIT_SAMPLE_CONTEXT_COHERENCY_PL.md) → [FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md](FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md) → [FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md](FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md) → [FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md](FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md) → [FW-126_TO_FW-127_AGENT_HANDOFF_PL.md](FW-126_TO_FW-127_AGENT_HANDOFF_PL.md) + [FW-126_HW_TEST_PROCEDURE_PL.md](FW-126_HW_TEST_PROCEDURE_PL.md) |
| **jednostki toru wspomagania** (kg → tryb → moc → Iq, kalibracja czujnika vs odczucie jazdy, dlaczego 320% nie dawało 320%) | [FW-129B_STATE_HYGIENE_REPORT_PL.md](FW-129B_STATE_HYGIENE_REPORT_PL.md) (zacznij TU — **FW-129B: CLOSED / PASS, HW VALIDATION PENDING AS CONSOLIDATED RIDE**) → [FW-129_IMPLEMENTATION_REPORT_PL.md](FW-129_IMPLEMENTATION_REPORT_PL.md) (tabela BEFORE/AFTER, co otwarte) → [FW-129_UNIT_DOMAIN_AUDIT_PL.md](FW-129_UNIT_DOMAIN_AUDIT_PL.md) (audyt: 12 wad D1–D12 z wyprowadzeniami) |
| **który BIN wgrać / czy artefakty są reprodukowalne** | [FW-129B_STATE_HYGIENE_REPORT_PL.md](FW-129B_STATE_HYGIENE_REPORT_PL.md) sekcja 14 (bit-for-bit rebuild, dlaczego manifest ma `13b5c6a` a commit to `3caca6b`, rekomendowany artefakt: **DIAG 0.0455**) |
...
| **dynamika jazdy / Ramp Up / Ramp Down / dlaczego wspomaganie ciągnie po puszczeniu nacisku** | [EVISTDRIVE_DYNAMICS_CURRENT_STATE_PL.md](EVISTDRIVE_DYNAMICS_CURRENT_STATE_PL.md) (zacznij TU — pełny tor sygnału, tabela mechanizmów, rachunek czasu zaniku) → [EVISTDRIVE_DYNAMICS_TARGET_ARCHITECTURE_PL.md](EVISTDRIVE_DYNAMICS_TARGET_ARCHITECTURE_PL.md) (cel + warianty A/B/C) → [EVISTDRIVE_DYNAMICS_MIGRATION_PLAN_PL.md](EVISTDRIVE_DYNAMICS_MIGRATION_PLAN_PL.md) (kroki STEP 0..9) |
| **czy pole w CANable naprawdę coś robi** (martwe i mylące parametry odczucia jazdy) | [EVISTDRIVE_CANABLE_FUNCTIONAL_CONTRACT_PL.md](EVISTDRIVE_CANABLE_FUNCTIONAL_CONTRACT_PL.md) + [EVISTDRIVE_ARCHITECTURE_DEBT_PL.md](EVISTDRIVE_ARCHITECTURE_DEBT_PL.md) |
| **Walk Assist** (siła startu, trzymanie obrotów zębatki, odcinanie od prędkości koła) | [WALK_ASSIST_DZIALANIE.md](WALK_ASSIST_DZIALANIE.md) (zacznij TU — jak to działa dziś) → [FW-130_WALK_ASSIST_G532_PL.md](FW-130_WALK_ASSIST_G532_PL.md) (bieżąca karta: audyt trzech przyczyn, porównanie z G532 i TSDZ2, prawo B, A/B `WALK_GOVERNOR_ENABLE`) |
| **jak nazywa się dana funkcja w kodzie kontra w aplikacji** | [EVISTDRIVE_TERMINOLOGY_ALIAS_PL.md](EVISTDRIVE_TERMINOLOGY_ALIAS_PL.md) |
