...
| **quiet start / quiet stop / FW-117 / MOE / neutral CCR** | [QS-1 diagnostics](QS-1_QUIET_START_STOP_TRANSITION_DIAGNOSTICS_PL.md) — DIAG-only capture i HMI version; [QS-0/QS-0B audit](QS-0_QUIET_START_STOP_CURRENT_ARCHITECTURE_AUDIT_PL.md); [G532 source](G532_CICHY_START_STOP_EVISTDRIVE_AGENT_PL.md). |
