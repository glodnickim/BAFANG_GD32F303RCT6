...
| **kanoniczna numeracja buildów** | [Globalny alokator wersji](BUILD_VERSION_GLOBAL_ALLOCATOR_AUDIT_FIX_PL.md) — rzeczywisty HWM 0.0459, lock atomowy, oficjalna para NORMAL+DIAG (`build-canonical-pair.ps1`) i tryby AUTO/REPRO/Developer. |
