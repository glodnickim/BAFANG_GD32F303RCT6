...
| **okno próbkowania ADC / zbocze TIMER0_CH3 / droga do FW-127** | [FW-127_STATUS.md](FW-127_STATUS.md) (zacznij TU — stan bieżący) → [FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md](FW-126.7_PRODUCTION_CURRENT_CAL_REPLACEMENT_PL.md) (bieżąca karta) → [FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md](FW-126.6_CURRENT_SENSE_VALID_STATE_PL.md) → [FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md](FW-126.5_RAW_DOMAIN_BRIDGE_STATE_PL.md) → [FW-126_TO_FW-127_AGENT_HANDOFF_PL.md](FW-126_TO_FW-127_AGENT_HANDOFF_PL.md) + [FW-126_HW_TEST_PROCEDURE_PL.md](FW-126_HW_TEST_PROCEDURE_PL.md) |
